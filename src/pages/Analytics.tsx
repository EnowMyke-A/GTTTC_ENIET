...
const Analytics = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[70vh]">
      <h1 className="text-2xl sm:text-3xl font-bold text-muted-foreground/85 mb-2">Statistics</h1>
      <p className="text-muted-foreground/80 text-center max-w-md">Comprehensive academic performance analytics will be available in a future update.</p>
    </div>
  );
